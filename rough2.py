...
'''
b = geek.zeros(2, dtype = int) OR b = geek.ones(2, dtype = int)
print("Matrix b : \n", b)
...
# pass display,line color,staring pos of line(tuple),end pos of line(tuple),width of the line.
# pygame.draw.line(display, BLACK, (10, 10), (300, 300), 10)


'''
"""
# is the middle sq available
